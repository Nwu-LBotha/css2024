...
if selected == "Data: Pt/Pd bulks":
    ...
    data_url2 = 'https://github.com/Nwu-LBotha/css2024/raw/main/My-streamlit_app/media/Paper2_bulkdata.xlsx'
    fig1_data = pd.read_excel(data_url2, sheet_name='figure1', index_col=None)
